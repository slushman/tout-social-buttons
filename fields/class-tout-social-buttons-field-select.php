...
class Tout_Social_Buttons_Field_Select extends Tout_Social_Buttons_Field {
	...
	protected function set_default_select_attributes() {
		...
		$this->default_attributes['aria-label'] = __( 'Select an option.', 'tout-social-buttons' );
	...
	protected function set_default_select_properties() {
		...
		$this->default_properties['blank'] = __( '- Select -', 'tout-social-buttons' );
		$this->default_properties['error'] = __( 'There was an error with the options for this field.', 'tout-social-buttons' );
